...
contains(INFO_NEED_QT_PLUGINS, 1) {
    DEFINES += INFO_NEED_QT_PLUGINS
...
HEADERS += src/qt/infocoingui.h \
    ...
    src/qt/infocoinaddressvalidator.h \
    src/addrman.h \
    src/base58.h \
    src/bignum.h \
    src/chainparams.h \
...
SOURCES += src/qt/infocoin.cpp src/qt/infocoingui.cpp \
    ...
    src/qt/infocoinstrings.cpp \
    src/qt/infocoinamountfield.cpp \
    src/wallet.cpp \
    src/keystore.cpp \
...
# also add new translations to src/qt/infocoin.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/infocoin_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/infocoin-qt.rc
...
windows:RC_FILE = src/qt/res/infocoin-qt.rc
