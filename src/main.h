...
static const unsigned int MAX_BLOCK_SIZE = 7500000;
...
/** Protocol 3.0 toggle */
inline bool IsProtocolV2_1(int64_t nTime) { return TestNet() || nTime > 1493596800; } // Mon, 01 May 2017 00:00:00 GMT
...
static const int64_t VELOCITY_TDIFF = 0; // Use Velocity's retargetting method (Height).
/** VRX retarget feature toggle */
static const int64_t VRX_FDIFF = 9993058800; // Use Velocity's retargetting method (Time).
/** VRX retarget min-diff mining toggle */
static const int64_t VRX_MDIFF = 9993058800; // Use Velocity's min-diff method (Time).
...
public:
    ...
    /** Amount of infocoins spent by this transaction.
    ...
    /** Amount of infocoins coming in to this transaction
