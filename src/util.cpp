...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Infocoin
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Infocoin
    // Mac: ~/Library/Application Support/Infocoin
    // Unix: ~/.infocoin
#ifdef WIN32
    // Windows
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good())
    {
        boost::filesystem::path ConfPath;
               ConfPath = GetDataDir() / "infocoin.conf";
    ...
    {
        // Don't overwrite existing settings so command line settings override infocoin.conf
...
// Format the subversion field according to BIP 14 spec (https://en.infocoin.it/wiki/BIP_0014)
