...
InfocoinGUI::InfocoinGUI(QWidget *parent):
    QMainWindow(parent),
    clientModel(0),
    walletModel(0),
    toolbar(0),
    ...
    blockBrowserPage(0)
{
    ...
    setWindowIcon(QIcon(":icons/infocoin"));
#else
...
void InfocoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Infocoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/infocoin"), tr("&About Infocoin"), this);
    aboutAction->setToolTip(tr("Show information about Infocoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Infocoin"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/infocoin"), tr("&Show / Hide"), this);
...
void InfocoinGUI::createMenuBar()
{
...
void InfocoinGUI::createToolBars()
{
...
void InfocoinGUI::setClientModel(ClientModel *clientModel)
{
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/infocoin_testnet"));
            setWindowIcon(QIcon(":icons/infocoin_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/infocoin_testnet"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Infocoin client") + QString(" ") + tr("[testnet]"));
...
void InfocoinGUI::setWalletModel(WalletModel *walletModel)
{
...
void InfocoinGUI::createTrayIcon()
{
    QMenu *trayIconMenu;
#ifndef Q_OS_MAC
...
#ifndef Q_OS_MAC
void InfocoinGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
...
void InfocoinGUI::optionsClicked()
{
...
void InfocoinGUI::setNumConnections(int count)
{
    QString icon;
    switch(count)
    {
...
void InfocoinGUI::setNumBlocks(int count)
{
...
void InfocoinGUI::message(const QString &title, const QString &message, bool modal, unsigned int style)
{
    QString strTitle = tr("Infocoin") + " - ";
...
void InfocoinGUI::changeEvent(QEvent *e)
{
...
void InfocoinGUI::closeEvent(QCloseEvent *event)
{
    if(clientModel)
    {
#ifndef Q_OS_MAC // Ignored on Mac
...
void InfocoinGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    if (!clientModel || !clientModel->getOptionsModel())
        return;
    ...
    QString strMessage = tr("This transaction is over the size limit. You can still send it for a fee of %1, "
        ...
        "Do you want to pay the fee?").arg(InfocoinUnits::formatWithUnit(clientModel->getOptionsModel()->getDisplayUnit(), nFeeRequired));
...
void InfocoinGUI::incomingTransaction(const QModelIndex & parent, int start, int end)
{
        ...
        notificator->notify(Notificator::Information,
                            (amount)<0 ? tr("Sent transaction") :
                              ...
                              tr("Date: %1\n"
                                 ...
                                 "Address: %4\n")
                              .arg(date)
                              .arg(InfocoinUnits::formatWithUnit(walletModel->getOptionsModel()->getDisplayUnit(), amount, true))
                              .arg(type)
                              .arg(address), icon);
    }
}

void InfocoinGUI::gotoOverviewPage()
{
...
void InfocoinGUI::gotoHistoryPage()
{
...
void InfocoinGUI::gotoAddressBookPage()
{
...
void InfocoinGUI::gotoBlockBrowser(QString transactionId)
{
...
void InfocoinGUI::gotoSendCoinsPage()
{
...
void InfocoinGUI::gotoSignMessageTab(QString addr)
{
...
void InfocoinGUI::gotoVerifyMessageTab(QString addr)
{
...
void InfocoinGUI::dragEnterEvent(QDragEnterEvent *event)
{
    // Accept only URIs
...
void InfocoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Infocoin address or malformed URI parameters."));
    }

    event->acceptProposedAction();
}

void InfocoinGUI::handleURI(QString strURI)
{
    // URI has to be valid
...
void InfocoinGUI::setEncryptionStatus(int status)
{
    switch(status)
    {
...
void InfocoinGUI::encryptWallet()
{
    if(!walletModel)
        return;
...
void InfocoinGUI::changePassphrase()
{
...
void InfocoinGUI::showNormalIfMinimized(bool fToggleHidden)
{
...
void InfocoinGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void InfocoinGUI::updateWeight()
{
    if (!pwalletMain)
        return;
...
void InfocoinGUI::updateStakingIcon()
{
    updateWeight();
...
void InfocoinGUI::detectShutdown()
{
