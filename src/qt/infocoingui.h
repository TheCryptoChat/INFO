...
/**
  Infocoin GUI main class. This class represents the main window of the Infocoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class InfocoinGUI : public QMainWindow
{
    Q_OBJECT

public:
    explicit InfocoinGUI(QWidget *parent = 0);
    ~InfocoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a infocoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
